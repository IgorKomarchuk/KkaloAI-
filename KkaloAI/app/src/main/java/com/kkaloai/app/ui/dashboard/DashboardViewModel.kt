...
class DashboardViewModel @Inject constructor(
    ...
    val achievementUnlocks = achievementEngine.unlocks
    ...
    fun addWater(amountMl: Int) {
        viewModelScope.launch {
            ...
            val today = waterDao.getTotalForDay(startOfDay).first()
            achievementEngine.onWaterAdded(today, today)
            runCatching {
                if (healthConnectManager.hasAllPermissions()) {
